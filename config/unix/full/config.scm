;;;; @(#)$Header: /u/master/rhizome/config/unix/full/config.scm,v 1.4 2004/07/23 04:34:38 qfwfq Exp $
; $Log: config.scm,v $
; Revision 1.4  2004/07/23 04:34:38  qfwfq
; change -m option in CFLAGS
;
; Revision 1.3  2004/04/09 05:11:14  qfwfq
; ELF, W^X and pthread on OpenBSD.
;
; Revision 1.2  2002/09/27 08:37:27  qfwfq
; Add support of linux and lcc-win32.
;
; Revision 1.1  1999/06/15 07:14:19  qfwfq
...
(define-syntax ld-lib-str
  (syntax-rules (dynamic loadable)
    ((_ dynamic) "-lrhzpisys -lpthread -lm")
    ((_ loadable) #f)
